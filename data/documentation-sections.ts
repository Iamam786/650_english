...
export const documentationSections: DocumentationSection[] = [
    {
        ...
        icon: Hand, // Changed from Handshake to Hand
...
How are you?`,
    },
    {
        ...
        icon: Waves, // Changed from Handshake to Waves
...
Peace`,
    },
    {
        id: "introductions",
        title: "Introductions",
        icon: UserPlus, // Changed from Zap to UserPlus
...
- I'd like you to meet Anna. She has been a friend of mine for ten years.`,
    ...
    {
        id: "talking-about-likes",
        title: "Talking about Likes",
        icon: Heart, // Changed from Zap to Heart
...
- My favorite season is summer because I love the warm weather.`,
    ...
    {
        id: "talking-about-dislikes",
        title: "Talking about Dislikes",
        icon: ThumbsDown, // Changed from Zap to ThumbsDown
...
* Dislike is not very commonly used in American English. You can use it and it is correct but not used as often as 'don't like' or 'hate'.`,
    },
    {
        ...
        content: `What do you do, is a common question. 
...
I work in sales for a large telecommunications company.`,
    },
    {
        ...
        icon: Activity, // Changed from Zap to Activity
        content: `In the United States, it is common to ask someone 'What are you doing?'. 
...
Not much`,
    },
    {
        ...
        icon: History, // Changed from Zap to History
...
When I was growing up…`,
    ...
    {
        id: "talking-about-future",
        title: "Talking about the Future",
        icon: TrendingUp, // Changed from Zap to TrendingUp
        content: `Talking about something that you will do or want to do in the future is very common. Below you will learn some phrases to help you talk about the future or something that hasn't happened yet.
...
When I retire I am going to travel a lot.`,
    },
    {
        id: "routines",
        title: "Routines",
        icon: RefreshCw, // Changed from Zap to RefreshCw
...
I go to Italy every summer.`,
    },
    {
        ...
        icon: Gamepad2, // Changed from Zap to Gamepad2
...
How many siblings do you have?`,
    },
    {
        id: "relationships",
        title: "Relationships",
        icon: Users, // Changed from Zap to Users
...
How did you meet each other?`,
    },
    {
        ...
        icon: User, // Changed from Zap to User
        content: `There are many ways to describe someone. Below you will learn some of the most basic ways to describe someone.
...
Mean (rude, has a bad attitude, treats other people badly)`,
    },
    {
        id: "food",
        title: "Food",
        icon: Utensils, // Changed from Zap to Utensils
...
8- What is in this food?`,
    },
    {
        id: "weather",
        title: "Weather",
        icon: Cloud, // Changed from Zap to Cloud
...
Isn't it beautiful today?`,
    },
    {
        ...
        icon: Car, // Changed from Zap to Car
...
What time does the next _____ come? (bus, train, etc.)`,
    },
    {
        id: "telling-time",
        title: "Telling Time",
        icon: Clock, // Changed from Zap to Clock
...
10:15= It's ten fifteen. or It's quarter past ten.
...
How long is the English class?`,
    },
    {
        id: "directions",
        title: "Directions",
        icon: MapPin, // Changed from Zap to MapPin
...
Is there a ________ close by?`,
    },
    {
        ...
        icon: Calendar, // Changed from Zap to Calendar
...
What year did you _______? (go to Brazil, move to New York, etc.)`,
    },
    {
        id: "numbers",
        title: "Numbers",
        icon: Hash, // Changed from Zap to Hash
...
When talking about numbers or the amount of something you will say… 'How many __________?'
...
How much do you pay for car insurance?`,
    },
    {
        ...
        icon: Globe, // Changed from Zap to Globe
...
She lives in Los Angeles.`,
    },
    {
        id: "tv-movies",
        title: "TV & Movies",
        icon: Tv, // Changed from Zap to Tv
        content: `Watching TV and movies is something that most people enjoy.
...
5- I live with my sister in an apartment.`,
    },
    {
        ...
        icon: ShoppingCart, // Changed from Zap to ShoppingCart
        content: `Everyone needs to eat. When you need to buy food you go to the grocery store or supermarket. Below you will learn vocabulary and phrases to help you go grocery shopping.

Shopping Cart: Buggy/Car you push around and put food in
Shopping Basket: something you carry and put food in
Aisle: Corridor or lane that food is separated into
...
Produce: fruits and vegetables section
Dairy: milk, cheese and yogurt section
Bakery: bread, donuts, cakes section
Frozen Food: many types of food are frozen in freezers, ice cream, pizza, meals for one person, etc.
Deli: have sliced cheese and meats and salads available for purchase
Out of Stock: there are no more left

When will you get more ____________?

Cashier: the person that rings up your order
Paper or plastic?: the kind of bag would you like to use; one made out of paper or one that is plastic
Coupons: paper or electronic discounts that let you purchase an item for less money
...
Do you have any coupons?`,
    },
    {
        ...
        icon: Coffee, // Changed from Zap to Coffee
        content: `It is nice to go out to eat or drink once in a while. Order food in a public place can be difficult, especially if you are learning a new language.
...
Can I get a doggy bag?`,
    },
    {
        ...
        icon: Shirt, // Changed from Zap to Shirt
...
How much does this cost?`,
    },
    {
        ...
        icon: Stethoscope, // Changed from Zap to Stethoscope
        content: `Everyone gets sick once in a while. Below you will find phrases to help you talk about sickness in English.
...
Headache- head hurts
Stomachache- stomach hurts
Dizzy- feel light headed, or that the room is spinning
Earache- ear hurts
Cough- a loud noise from lungs/mouth when you expel air
Diarrhea- go to the bathroom (defecate) at lot, many times
...
I have been dizzy for a few hours. I'm not sure why.`,
    ...
    {
        id: "crime-safety-police",
        title: "Crime, Safety and Police",
        icon: Shield, // Changed from Zap to Shield
        content: `Crime, safety and police are topics that you should know how to talk about. Even if you do not experience crime first hand; you will hear and see crime talked about on the news and TV. It is a common topic.
...
Charged with _____:
Ticket/Fine: Money you have to pay to the police or government for breaking or violating a law. (For example: parking illegally, driving too fast, etc.)

List of Crimes/Problems:
Robbed- something was taken without permission
Pick pocketed- wallet was stolen/taken
Car Jacked- car was robbed/removed from owner
Car accident- cars hit each other and resulted in damage/injury`,
    },
    {
        id: "problems-advice",
        title: "Problems/Advice",
        icon: Lightbulb, // Changed from Zap to Lightbulb
...
Advice: If I were you, I would ask the professor if you can take it again.`,
    ...
    {
        id: "making-plans-excuses",
        title: "Making Plans/Making Excuses",
        icon: CalendarCheck, // Changed from Zap to CalendarCheck
...
I have other plan on Saturday.`,
    },
    {
        id: "invitations",
        title: "Invitations",
        icon: Mail, // Changed from Zap to Mail
...
Let me check my calendar and get back to you.`,
    ...
    {
        id: "talking-about-feelings",
        title: "Talking about Your feelings",
        icon: Smile, // Changed from Zap to Smile
...
I don't like it when it _____________. It makes me feel __________.`,
    },
    {
        ...
        icon: Check, // Changed from Zap to Check
...
I love Justin Bieber. Respond: "I don't."`,
    },
    {
        ...
        icon: Scale, // Changed from Zap to Scale
...
This shirt is nicer than that one.`,
    },
    {
        ...
        icon: MessageSquare, // Changed from Zap to MessageSquare
...
5- I'd suggest we go to McDonalds instead of Burger King.`,
    },
    {
        id: "complaining",
        title: "Complaining",
        icon: Frown, // Changed from Zap to Frown
...
- I'm not satisfied with the service. The waiter hasn't been to our table in more than 20 minutes.`,
    },
    {
        ...
        icon: HelpCircle, // Changed from Zap to HelpCircle
...
Did you see the movie?`,
    },
    {
        id: "interjections",
        title: "Interjections",
        icon: Volume2, // Changed from Zap to Volume2
...
Expresses: Disgust.`,
    },
    {
        ...
        icon: Star, // Changed from Zap to Star
...
Thanks again for your support! For more tips, articles, video and activities to help you improve your English please visit my website: English-Tonight.com`,
    },
    {
        id: "other-books",
        title: "Other Books By This Author",
        icon: BookOpen, // Changed from Zap to BookOpen
